...
const HasBirthdayLaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        let speakOutput = handlerInput.t('Happy', { age: age });
...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = handlerInput.t('Hello! Welcome to cake walk. When is your birthday?');
        const repromptOutput = handlerInput.t('I was born November sixth, two thousand fourteen. When were you born?');
        return handlerInput.responseBuilder
            .speak(speakOutput)
...
const BirthdayIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        const speakOutput = handlerInput.t(`Thanks, I'll remember that your birthday is ${month} ${day} ${year}.`);
        return handlerInput.responseBuilder
            .speak(speakOutput)
